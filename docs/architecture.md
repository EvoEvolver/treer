...
| --- | --- | --- |
| [`treer-proxy`](../crates/treer-proxy/src/main.rs) | Public API, user auth, workload token signing, SQLite metadata, workspace projection, command and stream routing, domain-event publication | Local process lifetime |
