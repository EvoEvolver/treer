...
use crate::types::{FilePreview, FileTreeNode};
...
pub fn list_tree(root: &Path, rel: &str) -> Result<Vec<FileTreeNode>> {
...
pub fn preview_file(root: &Path, rel: &str, limit: usize) -> Result<FilePreview> {
