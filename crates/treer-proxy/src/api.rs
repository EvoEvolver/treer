...
fetch "$artifact_base/$platform/treer-acp" "$tmp_dir/treer-acp"
chmod 755 "$tmp_dir/treer" "$tmp_dir/treer-agent-host" "$tmp_dir/treer-agent-server" "$tmp_dir/treer-acp"
...
mv "$tmp_dir/treer-acp" "$server_dir/treer-acp"
ln -sf "$server_dir/treer-agent-server" "$install_dir/treer-agent-server"
ln -sf "$server_dir/treer-acp" "$install_dir/treer-acp"
